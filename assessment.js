...
var myFriends = ["Hannah", "Andy", "Aidan", "Dominic"] // CODE HERE
...
var myArray = [1, 2, 3, 4];
//DON'T TOUCH THE CODE ABOVE
var myArrayCopy = myArray.map(i => i); // CODE HERE
...
var filterPeople = (peopleIknow) => {
  return peopleIknow.friend === true;
}
var trueFriends = peopleIknow.filter(filterPeople);
...
// var indexes = []
// var indexFinder = randomNumbers.indexOf(i);
// while(indexFinder == 0){
//   indexes.push(indexFinder);
//   indexFinder = randomNumbers.indexOf(i)
// }
